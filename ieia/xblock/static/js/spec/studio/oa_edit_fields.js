...
describe("ieia.InputControl", function() {
    ...
    it("should show the error message when validate is called and there is an error", function() {
        ...
        expect(inputControl.input.parent().nextAll('.message-status').hasClass("is--hidden")).toBe(false);
    });
    ...
    it("should clear the errors when clearValidationErrors is called", function() {
        ...
        expect(inputControl.input.parent().nextAll('.message-status').hasClass("is--hidden")).toBe(true);
    });
